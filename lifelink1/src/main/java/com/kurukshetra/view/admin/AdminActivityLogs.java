...
public class AdminActivityLogs {
    ...
    public static VBox getActivityLogsPage() {
        ...
        VBox filterCard = new VBox(18);
        filterCard.setPadding(new Insets(20));
        filterCard.setStyle(BASE_CARD_STYLE);

        Label filterTitle = new Label("Activity Filters");
        filterTitle.setStyle(FONT_STACK + "-fx-font-size: 18px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");
        ...
        Label searchLabel = new Label("SEARCH ACTIVITY");
        searchLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-fill: " + TEXT_MUTED + "; -fx-text-fill: " + TEXT_MUTED + ";");

        TextField searchField = new TextField();
        searchField.setPromptText("Search activity, user or action...");
        searchField.setPrefHeight(42);
        searchField.setStyle(CONTROL_INPUT_STYLE);
        ...
        Label activityTypeLabel = new Label("ACTIVITY TYPE");
        activityTypeLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-fill: " + TEXT_MUTED + "; -fx-text-fill: " + TEXT_MUTED + ";");

        ComboBox<String> activityTypeCombo = new ComboBox<>();
        activityTypeCombo.getItems().addAll("All Activities", "Login", "Logout", "Hospital", "Ambulance", "User Management", "Settings");
        activityTypeCombo.setValue("All Activities");
        activityTypeCombo.setMaxWidth(Double.MAX_VALUE);
        activityTypeCombo.setPrefHeight(42);
        activityTypeCombo.setStyle(CONTROL_INPUT_STYLE);
        ...
        Label dateLabel = new Label("DATE");
        dateLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-fill: " + TEXT_MUTED + "; -fx-text-fill: " + TEXT_MUTED + ";");

        ComboBox<String> dateCombo = new ComboBox<>();
        dateCombo.getItems().addAll("All Time", "Today", "Yesterday", "Last 7 Days", "Last 30 Days");
        dateCombo.setValue("Today");
        dateCombo.setMaxWidth(Double.MAX_VALUE);
        dateCombo.setPrefHeight(42);
        dateCombo.setStyle(CONTROL_INPUT_STYLE);

        dateBox.getChildren().addAll(dateLabel, dateCombo);

        Button filterButton = new Button("Apply Filters");
        filterButton.setPrefHeight(42);
        filterButton.setPadding(new Insets(0, 24, 0, 24));
        filterButton.setStyle(PRIMARY_BUTTON_STYLE);
        ...
        VBox totalActivities = new VBox(6);
        totalActivities.setPadding(new Insets(18));
        totalActivities.setStyle(BASE_CARD_STYLE);
        HBox.setHgrow(totalActivities, Priority.ALWAYS);

        Label totalLabel = new Label("TOTAL ACTIVITIES");
        totalLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label totalValue = new Label("1,284");
        totalValue.setStyle(FONT_STACK + "-fx-font-size: 26px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_DARK + ";");

        Label totalSubtitle = new Label("Recorded today");
        totalSubtitle.setStyle(FONT_STACK + "-fx-font-size: 12px; -fx-text-fill: " + TEXT_MUTED + ";");

        totalActivities.getChildren().addAll(totalLabel, totalValue, totalSubtitle);

        VBox successfulActivities = new VBox(6);
        successfulActivities.setPadding(new Insets(18));
        successfulActivities.setStyle(BASE_CARD_STYLE);
        HBox.setHgrow(successfulActivities, Priority.ALWAYS);

        Label successLabel = new Label("SUCCESSFUL ACTIONS");
        successLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label successValue = new Label("1,241");
        successValue.setStyle(FONT_STACK + "-fx-font-size: 26px; -fx-font-weight: bold; -fx-text-fill: " + SUCCESS_TEXT + ";");

        Label successSubtitle = new Label("96.6% success rate");
        successSubtitle.setStyle(FONT_STACK + "-fx-font-size: 12px; -fx-text-fill: " + TEXT_MUTED + ";");

        successfulActivities.getChildren().addAll(successLabel, successValue, successSubtitle);

        VBox failedActivities = new VBox(6);
        failedActivities.setPadding(new Insets(18));
        failedActivities.setStyle(BASE_CARD_STYLE);
        HBox.setHgrow(failedActivities, Priority.ALWAYS);

        Label failedLabel = new Label("FAILED ACTIONS");
        failedLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label failedValue = new Label("43");
        failedValue.setStyle(FONT_STACK + "-fx-font-size: 26px; -fx-font-weight: bold; -fx-text-fill: " + DANGER_TEXT + ";");

        Label failedSubtitle = new Label("Requires attention");
        failedSubtitle.setStyle(FONT_STACK + "-fx-font-size: 12px; -fx-text-fill: " + TEXT_MUTED + ";");

        failedActivities.getChildren().addAll(failedLabel, failedValue, failedSubtitle);

        VBox activeUsers = new VBox(6);
        activeUsers.setPadding(new Insets(18));
        activeUsers.setStyle(BASE_CARD_STYLE);
        HBox.setHgrow(activeUsers, Priority.ALWAYS);

        Label activeLabel = new Label("ACTIVE ADMINS");
        activeLabel.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label activeValue = new Label("18");
        activeValue.setStyle(FONT_STACK + "-fx-font-size: 26px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_PRIMARY + ";");

        Label activeSubtitle = new Label("Currently online");
        activeSubtitle.setStyle(FONT_STACK + "-fx-font-size: 12px; -fx-text-fill: " + TEXT_MUTED + ";");
        ...
        VBox activityCard = new VBox();
        activityCard.setStyle(BASE_CARD_STYLE);

        VBox activityHeader = new VBox(4);
        activityHeader.setPadding(new Insets(20));
        activityHeader.setStyle("-fx-border-color: " + BORDER_DIVIDER + "; -fx-border-width: 0px 0px 1px 0px;");

        Label activityTitle = new Label("Recent Activity");
        activityTitle.setStyle(FONT_STACK + "-fx-font-size: 18px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label activitySubtitle = new Label("Latest actions performed by administrators and system users.");
        activitySubtitle.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        activityHeader.getChildren().addAll(activityTitle, activitySubtitle);
        ...
        Label timeHeader = new Label("TIME");
        timeHeader.setPrefWidth(130);
        timeHeader.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_DARK + ";");

        Label userHeader = new Label("USER");
        userHeader.setPrefWidth(180);
        userHeader.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_DARK + ";");

        Label actionHeader = new Label("ACTION");
        actionHeader.setPrefWidth(240);
        actionHeader.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_DARK + ";");

        Label moduleHeader = new Label("MODULE");
        moduleHeader.setPrefWidth(170);
        moduleHeader.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_DARK + ";");

        Label statusHeader = new Label("STATUS");
        statusHeader.setPrefWidth(120);
        statusHeader.setStyle(FONT_STACK + "-fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + PURPLE_DARK + ";");
        ...
        // Status Badge Style Constants
        String successBadgeStyle = FONT_STACK +
        ...
        String tableRowStyle = "-fx-border-color: " + BORDER_DIVIDER + "; -fx-border-width: 0px 0px 1px 0px;";
        ...
        row1.setAlignment(Pos.CENTER_LEFT);
        row1.setPadding(new Insets(16, 20, 16, 20));
        row1.setStyle(tableRowStyle);

        Label time1 = new Label("01:02 PM");
        time1.setPrefWidth(130);
        time1.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_MUTED + ";");

        Label user1 = new Label("Admin");
        user1.setPrefWidth(180);
        user1.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label action1 = new Label("Updated system settings");
        action1.setPrefWidth(240);
        action1.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label module1 = new Label("System Settings");
        module1.setPrefWidth(170);
        module1.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label status1 = new Label("SUCCESS");
        status1.setPrefWidth(90);
        status1.setStyle(successBadgeStyle);

        row1.getChildren().addAll(time1, user1, action1, module1, status1);
        ...
        Label time2 = new Label("12:48 PM");
        time2.setPrefWidth(130);
        time2.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_MUTED + ";");

        Label user2 = new Label("Admin");
        user2.setPrefWidth(180);
        user2.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label action2 = new Label("Added new hospital");
        action2.setPrefWidth(240);
        action2.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label module2 = new Label("Hospital Management");
        module2.setPrefWidth(170);
        module2.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label status2 = new Label("SUCCESS");
        status2.setPrefWidth(90);
        status2.setStyle(successBadgeStyle);

        row2.getChildren().addAll(time2, user2, action2, module2, status2);
        ...
        row3.setAlignment(Pos.CENTER_LEFT);
        row3.setPadding(new Insets(16, 20, 16, 20));
        row3.setStyle(tableRowStyle);

        Label time3 = new Label("12:35 PM");
        time3.setPrefWidth(130);
        time3.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_MUTED + ";");

        Label user3 = new Label("System Admin");
        user3.setPrefWidth(180);
        user3.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label action3 = new Label("Updated ambulance status");
        action3.setPrefWidth(240);
        action3.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label module3 = new Label("Ambulance Management");
        module3.setPrefWidth(170);
        module3.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label status3 = new Label("SUCCESS");
        status3.setPrefWidth(90);
        status3.setStyle(successBadgeStyle);

        row3.getChildren().addAll(time3, user3, action3, module3, status3);
        ...
        row4.setAlignment(Pos.CENTER_LEFT);
        row4.setPadding(new Insets(16, 20, 16, 20));
        row4.setStyle(tableRowStyle);

        Label time4 = new Label("11:56 AM");
        time4.setPrefWidth(130);
        time4.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_MUTED + ";");

        Label user4 = new Label("Admin");
        user4.setPrefWidth(180);
        user4.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label action4 = new Label("Viewed emergency report");
        action4.setPrefWidth(240);
        action4.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label module4 = new Label("Emergency Monitoring");
        module4.setPrefWidth(170);
        module4.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label status4 = new Label("SUCCESS");
        status4.setPrefWidth(90);
        status4.setStyle(successBadgeStyle);

        row4.getChildren().addAll(time4, user4, action4, module4, status4);
        ...
        row5.setAlignment(Pos.CENTER_LEFT);
        row5.setPadding(new Insets(16, 20, 16, 20));
        row5.setStyle("-fx-border-width: 0px;");

        Label time5 = new Label("11:24 AM");
        time5.setPrefWidth(130);
        time5.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_MUTED + ";");

        Label user5 = new Label("Admin");
        user5.setPrefWidth(180);
        user5.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label action5 = new Label("Created new user account");
        action5.setPrefWidth(240);
        action5.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label module5 = new Label("User Management");
        module5.setPrefWidth(170);
        module5.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        Label status5 = new Label("SUCCESS");
        status5.setPrefWidth(90);
        status5.setStyle(successBadgeStyle);

        row5.getChildren().addAll(time5, user5, action5, module5, status5);
        ...
        Label footerText = new Label("Showing 5 of 1,284 activities");
        footerText.setStyle(FONT_STACK + "-fx-font-size: 13px; -fx-text-fill: " + TEXT_MUTED + ";");

        Region footerSpacer = new Region();
        HBox.setHgrow(footerSpacer, Priority.ALWAYS);

        Button previousButton = new Button("Previous");
        previousButton.setPadding(new Insets(9, 18, 9, 18));
        previousButton.setStyle(SECONDARY_BUTTON_STYLE);

        Button nextButton = new Button("Next");
        nextButton.setPadding(new Insets(9, 18, 9, 18));
        nextButton.setStyle(PRIMARY_BUTTON_STYLE);
