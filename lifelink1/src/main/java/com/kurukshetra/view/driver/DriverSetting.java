...
public class DriverSetting {
    ...
    public BorderPane getAppSettingsPage(Runnable callBackDashboard) {
        ...
        saveButton.setOnAction(e -> {
            ...
            // NurseToast.show(DashboardPage.appOverlay, "Settings saved", "success");
        });
        ...
        FadeTransition fade = new FadeTransition(DriverAppSettings.dur(450), settingsRoot);
    ...
    public StackPane toggleSwitch(boolean initialOn) {
        ...
        toggle.setOnMouseClicked(e -> {
            ...
            TranslateTransition slideKnob = new TranslateTransition(DriverAppSettings.dur(160), knob);
