...
// public class HospitalAmbulanceTracking {
...
public class HospitalAmbulanceTracking {
    ...
    public VBox getAmbulanceTracking() {
        ...
        contentArea.setSpacing(0);
        contentArea.setPrefHeight(650);
        contentArea.setStyle("-fx-background-color: " + TEAL_VERY_LIGHT + ";");

        // Map
        Pane mapPane = new Pane();
        mapPane.setPrefWidth(760);
        mapPane.setPrefHeight(650);
        mapPane.setStyle("-fx-background-color: #E8F4F5; -fx-border-color: " + BORDER_COLOR + ";");
        HBox.setHgrow(mapPane, Priority.ALWAYS);
        ...
        Line emergencyRoute = new Line(180, 450, 590, 280);
        emergencyRoute.setStroke(Color.web(PRIMARY_TEAL));
        emergencyRoute.setStrokeWidth(6);

        Circle hospitalCircle = new Circle(180, 450, 16);
        hospitalCircle.setFill(Color.web(PRIMARY_TEAL));
        hospitalCircle.setStroke(Color.WHITE);
        hospitalCircle.setStrokeWidth(4);
        ...
        hospitalLabel.setLayoutX(140);
        hospitalLabel.setLayoutY(475);
        hospitalLabel.setStyle("-fx-background-color: " + SURFACE + "; -fx-background-radius: 6px; -fx-padding: 6px 10px; -fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + TEAL_DARK + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 6px;");

        Circle accidentCircle = new Circle(590, 150, 16);
        accidentCircle.setFill(Color.web(STATUS_DANGER_TEXT));
        accidentCircle.setStroke(Color.WHITE);
        accidentCircle.setStrokeWidth(4);
        ...
        accidentLabel.setLayoutX(525);
        accidentLabel.setLayoutY(175);
        accidentLabel.setStyle("-fx-background-color: " + SURFACE + "; -fx-background-radius: 6px; -fx-padding: 6px 10px; -fx-font-size: 11px; -fx-font-weight: bold; -fx-text-fill: " + STATUS_DANGER_TEXT + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 6px;");

        Circle ambulanceCircle = new Circle(500, 320, 18);
        ambulanceCircle.setFill(Color.web(PRIMARY_TEAL));
        ambulanceCircle.setStroke(Color.WHITE);
        ambulanceCircle.setStrokeWidth(4);
        ...
        ambulanceInfo.setLayoutX(530);
        ambulanceInfo.setLayoutY(300);
        ambulanceInfo.setStyle("-fx-background-color: " + SURFACE + "; -fx-background-radius: 8px; -fx-padding: 8px 12px; -fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 8px;");
        ...
        String mapBtnStyle = "-fx-background-color: " + SURFACE + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 6px; -fx-background-radius: 6px; -fx-text-fill: " + TEXT_PRIMARY + "; -fx-cursor: hand;";
        Button zoomIn = new Button("+");
        zoomIn.setPrefSize(40, 40);
        zoomIn.setStyle(mapBtnStyle + " -fx-font-size: 18px; -fx-font-weight: bold;");

        Button zoomOut = new Button("-");
        zoomOut.setPrefSize(40, 40);
        zoomOut.setStyle(mapBtnStyle + " -fx-font-size: 18px; -fx-font-weight: bold;");

        Button layersButton = new Button("☷");
        layersButton.setPrefSize(40, 40);
        layersButton.setStyle(mapBtnStyle + " -fx-font-size: 16px;");

        Button locationButton = new Button("⌖");
        locationButton.setPrefSize(40, 40);
        locationButton.setStyle(mapBtnStyle + " -fx-font-size: 18px;");

        mapControls.getChildren().addAll(zoomIn, zoomOut, layersButton, locationButton);

        mapPane.getChildren().addAll(
            road1, road2, road3, road4, emergencyRoute,
            hospitalCircle, hospitalLabel, accidentCircle, accidentLabel,
            ambulanceCircle, ambulanceIcon, ambulanceInfo, mapControls
        );
        ...
        informationPanel.setPrefWidth(360);
        informationPanel.setPadding(new Insets(18));
        informationPanel.setSpacing(16);
        informationPanel.setStyle("-fx-background-color: " + SURFACE + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-width: 0px 0px 0px 1px;");
        ...
        Label missionTitle = new Label("Active Mission");
        missionTitle.setStyle("-fx-font-size: 17px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");
        HBox.setHgrow(missionTitle, Priority.ALWAYS);

        Label urgentLabel = new Label("URGENT");
        urgentLabel.setStyle("-fx-background-color: " + STATUS_DANGER_BG + "; -fx-text-fill: " + STATUS_DANGER_TEXT + "; -fx-padding: 4px 8px; -fx-background-radius: 5px; -fx-font-size: 10px; -fx-font-weight: bold;");

        missionHeader.getChildren().addAll(missionTitle, urgentLabel);
        ...
        Label driverIcon = new Label("👨‍⚕");
        driverIcon.setPrefSize(48, 48);
        driverIcon.setAlignment(Pos.CENTER);
        driverIcon.setStyle("-fx-background-color: " + TEAL_VERY_LIGHT + "; -fx-background-radius: 10px; -fx-font-size: 24px;");

        VBox driverDetails = new VBox();
        driverDetails.setSpacing(3);

        Label driverName = new Label("Mike Ross");
        driverName.setStyle("-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");

        Label driverRole = new Label("Lead Paramedic • Badge #4421");
        driverRole.setStyle("-fx-font-size: 11px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        driverDetails.getChildren().addAll(driverName, driverRole);
        HBox.setHgrow(driverDetails, Priority.ALWAYS);

        Button callButton = new Button("☎");
        callButton.setPrefSize(36, 36);
        callButton.setStyle("-fx-background-color: " + TEAL_PALE + "; -fx-text-fill: " + PRIMARY_TEAL + "; -fx-background-radius: 50%; -fx-font-size: 16px; -fx-cursor: hand;");

        driverBox.getChildren().addAll(driverIcon, driverDetails, callButton);
        ...
        arrivalBox.setPadding(new Insets(10));
        arrivalBox.setSpacing(4);
        arrivalBox.setStyle("-fx-background-color: " + TEAL_PALE + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 8px; -fx-background-radius: 8px;");

        Label arrivalTitle = new Label("ESTIMATED ARRIVAL");
        arrivalTitle.setStyle("-fx-font-size: 10px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_MUTED + ";");

        Label arrivalValue = new Label("4 Minutes");
        arrivalValue.setStyle("-fx-font-size: 16px; -fx-font-weight: bold; -fx-text-fill: " + PRIMARY_TEAL + ";");
        arrivalBox.getChildren().addAll(arrivalTitle, arrivalValue);

        VBox distanceBox = new VBox();
        distanceBox.setPadding(new Insets(10));
        distanceBox.setSpacing(4);
        distanceBox.setStyle("-fx-background-color: " + TEAL_PALE + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 8px; -fx-background-radius: 8px;");

        Label distanceTitle = new Label("DISTANCE");
        distanceTitle.setStyle("-fx-font-size: 10px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_MUTED + ";");

        Label distanceValue = new Label("2.5 KM");
        distanceValue.setStyle("-fx-font-size: 16px; -fx-font-weight: bold; -fx-text-fill: " + PRIMARY_TEAL + ";");
        distanceBox.getChildren().addAll(distanceTitle, distanceValue);

        HBox.setHgrow(arrivalBox, Priority.ALWAYS);
        HBox.setHgrow(distanceBox, Priority.ALWAYS);
        routeStats.getChildren().addAll(arrivalBox, distanceBox);

        // Patient Status
        VBox patientSection = new VBox();
        patientSection.setSpacing(6);

        HBox patientStatusHeader = new HBox();
        patientStatusHeader.setAlignment(Pos.CENTER_LEFT);

        Label patientStatusTitle = new Label("PATIENT STATUS");
        patientStatusTitle.setStyle("-fx-font-size: 10px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_MUTED + ";");
        HBox.setHgrow(patientStatusTitle, Priority.ALWAYS);

        Label criticalLabel = new Label("🚨 Critical");
        criticalLabel.setStyle("-fx-text-fill: " + STATUS_DANGER_TEXT + "; -fx-font-size: 12px; -fx-font-weight: bold;");

        patientStatusHeader.getChildren().addAll(patientStatusTitle, criticalLabel);

        VBox traumaBox = new VBox();
        traumaBox.setSpacing(4);
        traumaBox.setPadding(new Insets(10));
        traumaBox.setStyle("-fx-background-color: " + STATUS_DANGER_BG + "; -fx-border-color: #F8B4BD; -fx-border-radius: 8px; -fx-background-radius: 8px;");

        Label traumaTitle = new Label("Trauma - Severe Bleeding");
        traumaTitle.setStyle("-fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + STATUS_DANGER_TEXT + ";");

        Label traumaDetails = new Label("Male, ~45yrs. Vital signs stabilized, awaiting rapid transport to OT 4.");
        traumaDetails.setWrapText(true);
        traumaDetails.setStyle("-fx-font-size: 11px; -fx-text-fill: " + TEXT_SECONDARY + ";");

        traumaBox.getChildren().addAll(traumaTitle, traumaDetails);
        patientSection.getChildren().addAll(patientStatusHeader, traumaBox);

        // Tracker
        VBox tracker = new VBox();
        tracker.setSpacing(12);

        Label trackerTitle = new Label("MISSION STATUS");
        trackerTitle.setStyle("-fx-font-size: 10px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_MUTED + ";");

        VBox dispatched = new VBox(2);
        Label dispatchedTitle = new Label("●  Ambulance Dispatched");
        dispatchedTitle.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");
        Label dispatchedTime = new Label("     14:02 PM");
        dispatchedTime.setStyle("-fx-font-size: 10px; -fx-text-fill: " + TEXT_MUTED + ";");
        dispatched.getChildren().addAll(dispatchedTitle, dispatchedTime);

        VBox extraction = new VBox(2);
        Label extractionTitle = new Label("●  On-site Extraction");
        extractionTitle.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + ";");
        Label extractionTime = new Label("     14:15 PM");
        extractionTime.setStyle("-fx-font-size: 10px; -fx-text-fill: " + TEXT_MUTED + ";");
        extraction.getChildren().addAll(extractionTitle, extractionTime);

        VBox transit = new VBox(2);
        Label transitTitle = new Label("●  In Transit to Hospital");
        transitTitle.setStyle("-fx-font-size: 12px; -fx-font-weight: bold; -fx-fill: " + PRIMARY_TEAL + "; -fx-text-fill: " + PRIMARY_TEAL + ";");
        Label transitStatus = new Label("     LIVE STATUS");
        transitStatus.setStyle("-fx-font-size: 10px; -fx-font-weight: bold; -fx-text-fill: " + PRIMARY_TEAL + ";");
        transit.getChildren().addAll(transitTitle, transitStatus);

        tracker.getChildren().addAll(trackerTitle, dispatched, extraction, transit);

        // Prepare OT Button
        Button prepareOTButton = new Button("▣   Prepare OT 4");
        prepareOTButton.setMaxWidth(Double.MAX_VALUE);
        prepareOTButton.setPrefHeight(40);
        prepareOTButton.setStyle("-fx-background-color: " + PRIMARY_TEAL + "; -fx-text-fill: white; -fx-font-size: 13px; -fx-font-weight: bold; -fx-background-radius: 8px; -fx-cursor: hand;");
        prepareOTButton.setOnMouseEntered(e -> prepareOTButton.setStyle("-fx-background-color: " + TEAL_DARK + "; -fx-text-fill: white; -fx-font-size: 13px; -fx-font-weight: bold; -fx-background-radius: 8px; -fx-cursor: hand;"));
        prepareOTButton.setOnMouseExited(e -> prepareOTButton.setStyle("-fx-background-color: " + PRIMARY_TEAL + "; -fx-text-fill: white; -fx-font-size: 13px; -fx-font-weight: bold; -fx-background-radius: 8px; -fx-cursor: hand;"));

        informationPanel.getChildren().addAll(missionHeader, driverBox, routeStats, patientSection, tracker, prepareOTButton);
        contentArea.getChildren().addAll(mapPane, informationPanel);
        ...
        bottomBar.setPadding(new Insets(10, 20, 10, 20));
        bottomBar.setAlignment(Pos.CENTER);
        bottomBar.setStyle("-fx-background-color: " + SURFACE + "; -fx-border-color: " + BORDER_COLOR + "; -fx-border-radius: 25px; -fx-background-radius: 25px;");

        Button contactDriver = new Button("💬  Contact Driver");
        contactDriver.setStyle("-fx-background-color: transparent; -fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + "; -fx-cursor: hand;");

        Button refreshLocation = new Button("⟳  Refresh Location");
        refreshLocation.setStyle("-fx-background-color: transparent; -fx-font-size: 13px; -fx-font-weight: bold; -fx-text-fill: " + TEXT_PRIMARY + "; -fx-cursor: hand;");

        Button dispatchUnit = new Button("🚑  Dispatch New Unit");
        dispatchUnit.setStyle("-fx-background-color: " + PRIMARY_TEAL + "; -fx-text-fill: white; -fx-padding: 9px 18px; -fx-background-radius: 20px; -fx-font-size: 13px; -fx-font-weight: bold; -fx-cursor: hand;");
        dispatchUnit.setOnMouseEntered(e -> dispatchUnit.setStyle("-fx-background-color: " + TEAL_DARK + "; -fx-text-fill: white; -fx-padding: 9px 18px; -fx-background-radius: 20px; -fx-font-size: 13px; -fx-font-weight: bold; -fx-cursor: hand;"));
        dispatchUnit.setOnMouseExited(e -> dispatchUnit.setStyle("-fx-background-color: " + PRIMARY_TEAL + "; -fx-text-fill: white; -fx-padding: 9px 18px; -fx-background-radius: 20px; -fx-font-size: 13px; -fx-font-weight: bold; -fx-cursor: hand;"));

        bottomBar.getChildren().addAll(contactDriver, refreshLocation, dispatchUnit);

        mainVBox.getChildren().addAll(topBar, contentArea, bottomBar);
        VBox.setVgrow(contentArea, Priority.ALWAYS);
        ...
        VBox ambulancePage = new VBox(scrollPane);
        VBox.setVgrow(scrollPane, Priority.ALWAYS);
