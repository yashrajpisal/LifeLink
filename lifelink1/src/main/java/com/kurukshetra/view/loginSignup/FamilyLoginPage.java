...
import com.kurukshetra.view.family.FamilyReviewPage;
import com.kurukshetra.view.family.MedicalReports;
    ...
    private void showLoginForm(VBox card) {
        ...
        loginButton.setOnAction(e -> {
            ...
            ModernAuthLoader.runAsyncAuth(
                    ...
                    "Authenticating...",
                    () -> {
                        FamilyHomePage.USER_EMAIL = emailValue;
                        MedicalReports.loggedInFamilyEmail = emailValue;
                        FamilyReviewPage.USER_EMAIL = emailValue;
                        return userAuthController.signIn(emailValue, passwordValue);
                    },
                    isSuccess -> {
                        if (isSuccess) {
                            System.out.println("Family login successful.");
                            showSuccessMessage(card, emailValue);
                        }
                    },
                    username,
                    password
