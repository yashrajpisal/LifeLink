...
//         private static final String POLICE_IMAGE_URL = "assets\\Images\\policeLogin.jpg";
...
//                 ImageView policeImage = createPoliceImage();
...
//                 VBox loginCard = createLoginCard(page);
...
//                 Region titleSpace = createSpacer(
//                                 25);
...
//                 Region space1 = createSpacer(
//                                 25);

//                 TextField username = createTextField(
//                                 "Username");

//                 Region space2 = createSpacer(
//                                 25);

//                 PasswordField password = createPasswordField(
//                                 "Password");

//                 StackPane passwordContainer = createPasswordVisibilityBox(
//                                 password);

//                 Region actionSpace = createSpacer(
//                                 40);
...
//                 Region signUpSpace = createSpacer(
//                                 35);
...
//                 // =====================================================
//                 // LOGIN ACTION - FULL SCREEN DASHBOARD FIX
//                 // =====================================================
...
//                                         "Authenticating...",
//                                         () -> {
//                                                 return userAuthController.signIn(usernameValue, passwordValue);
//                                         },
//                                         isSuccess -> {
//                                                 if (isSuccess) {
...
//                 forgot.setOnAction(
//                                 e -> System.out.println("Forgot Password clicked."));
...
//                                 e -> {
//                                         String color = password.isVisible() ? TEAL : PLACEHOLDER;
//                                         eyeButton.setStyle(eyeButtonStyle(color));
//                                 });
...
//                                 eyeButton.setText("🙈");
//                                 eyeButton.setStyle(eyeButtonStyle(TEAL));
...
//                                 eyeButton.setText("👁");
//                                 eyeButton.setStyle(eyeButtonStyle(PLACEHOLDER));
...
//                 Region loginSpace = createSpacer(
//                                 25);

//                 Button backToLogin = new Button("Already have an account? Login");
...
//                                 System.out.println("Please enter name, email and password.");
//                                 return;
//                         }
...
//                                         "Creating...",
//                                         () -> {
//                                                 boolean isSuccess = userAuthController.signUp(nameValue, emailValue,
//                                                                 passwordValue);
//                                                 if (isSuccess) {
...
//                         if (focused) {
//                                 field.setStyle(focusedFieldStyle());
//                         } else {
//                                 field.setStyle(normalFieldStyle());
//                         }
//                 });
...
//                                 "-fx-prompt-text-fill: " + PLACEHOLDER + ";" +
//                                 "-fx-padding: 0 40 0 19;" +
//                                 "-fx-effect: dropshadow(gaussian, rgba(8,127,140,0.18), 8, 0, 0, 0);";
//         }

//         private void setLoginButtonStyle(Button button, String color) {
//                 button.setStyle(loginButtonStyle(color));
//                 button.setOnMouseEntered(e -> button.setStyle(loginButtonStyle(TEAL_DARK)));
//                 button.setOnMouseExited(e -> button.setStyle(loginButtonStyle(color)));
//         }
...
//         private void setSignUpButtonStyle(Button button, String color) {
//                 button.setStyle(linkButtonStyle(color, 14));
//                 button.setOnMouseEntered(e -> button.setStyle(linkButtonStyle(TEAL_DARK, 14)));
//                 button.setOnMouseExited(e -> button.setStyle(linkButtonStyle(color, 14)));
//         }

//         private void setForgotButtonStyle(Button button, String color) {
//                 button.setStyle(linkButtonStyle(color, 15));
//                 button.setOnMouseEntered(e -> button.setStyle(linkButtonStyle(TEAL_DARK, 15)));
//                 button.setOnMouseExited(e -> button.setStyle(linkButtonStyle(color, 15)));
//         }

//         private String linkButtonStyle(String color, int fontSize) {
//                 return "-fx-background-color: transparent;" +
//                                 "-fx-text-fill: " + color + ";" +
//                                 "-fx-font-family: 'Segoe UI';" +
...
//         private void setFixedHeight(Region node, double height) {
//                 node.setPrefHeight(height);
//                 node.setMinHeight(height);
//                 node.setMaxHeight(height);
//         }
...
//                 blueShape.setFill(Color.web(TEAL));
//                 blueShape.setStroke(Color.TRANSPARENT);
//                 return blueShape;
//         }

//         private void updateBlueShape(Path shape, double width, double height) {
//                 shape.getElements().clear();
//                 double blueWidth = width * 0.53;
//                 double curveAmount = 130;

//                 shape.getElements().add(new MoveTo(0, 0));
//                 shape.getElements().add(new LineTo(blueWidth, 0));
//                 shape.getElements().add(new CubicCurveTo(blueWidth + curveAmount, height * 0.14,
//                                 blueWidth + curveAmount, height * 0.32, blueWidth, height * 0.50));
//                 shape.getElements().add(new CubicCurveTo(blueWidth - curveAmount, height * 0.68,
//                                 blueWidth - curveAmount, height * 0.86, blueWidth, height));
...
//                 try {
//                         Image image = new Image(POLICE_IMAGE_URL, false);
//                         imageView.setImage(image);
//                 } catch (Exception e) {
//                         System.out.println("Could not load police image: " + e.getMessage());
//                 }
...
//         private void updateImage(ImageView imageView, double width, double height) {
...
//                 try {
//                         Image logoImage = new Image(LIFELINK_LOGO_IMAGE, false);
//                         icon.setImage(logoImage);
//                 } catch (Exception e) {
//                         System.out.println("Could not load LifeLink logo: " + e.getMessage());
//                 }
...
//                 life.setStyle("-fx-fill: white; -fx-font-family: 'Segoe UI'; -fx-font-size: 33px; -fx-font-weight: bold;");

//                 Text link = new Text("Link");
//                 link.setStyle("-fx-fill: " + TEAL_LIGHT
//                                 + "; -fx-font-family: 'Segoe UI'; -fx-font-size: 33px; -fx-font-weight: bold;");

//                 HBox text = new HBox(0, life, link);
//                 logo.getChildren().addAll(icon, text);
//                 return logo;
//         }
// }
package com.kurukshetra.view.loginSignup;
...
public class PoliceLoginPage {
        ...
        private static final String TEAL = "#8a5941";
        private static final String TEAL_DARK = "#a36e53";
        private static final String TEAL_LIGHT = "#63D7DC";
        private static final String WHITE = "#FFFFFF";
        private static final String BLACK = "#111111";
        private static final String GRAY_BG = "#0B1329";
                ...
                loginButton.setOnAction(e -> {
                        ...
                        try {
                                ModernAuthLoader.runAsyncAuth(
                                                ...
                                                card,
                                                "Authenticating...",
                                                () -> userAuthController.signIn(usernameValue, passwordValue),
                                                isSuccess -> {
                                                        if (isSuccess) {
                                                                System.out.println("Police login successful.");
                                                                PoliceProfileController.loggedInEmail = usernameValue;
                                                                PoliceUserModel.getInstance().setPoliceUserData("", usernameValue);
                                ...
                                System.out.println("[PoliceLoginPage] Fallback direct authentication: " + t.getMessage());
                        ...
                        ModernAuthLoader.runAsyncAuth(
                                        ...
                                        () -> {
                                                ...
                                                if (isSuccess) {
                                                        UserController userController = new UserController();
                                                        userController.passToPoliceModel(nameValue, emailValue);
                                                        PoliceProfileController.loggedInEmail = emailValue;
                                                        PoliceUserModel.getInstance().setPoliceUserData(nameValue, emailValue);
                                                }
                                                return isSuccess;
                                        },
                                        isSuccess -> {
        ...
        private Image loadPoliceImage() {
                ...
                String[] files = {
                                "assets/Images/policeLogin.jpg",
                                "src/main/resources/assets/Images/policeLogin.jpg",
                                "lifelink1/src/main/resources/assets/Images/policeLogin.jpg"
                };
