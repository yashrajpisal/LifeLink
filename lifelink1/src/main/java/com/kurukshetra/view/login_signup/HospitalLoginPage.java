package com.kurukshetra.view.login_signup;
...
public class HospitalLoginPage {
        ...
        private static final String TEAL = "#087F8C";
        ...
        private void showLoginForm(VBox card) {
                ...
                Text hospitalData = new Text("System hospital");

                hospitalData.setStyle(
                                "-fx-fill: " + BLACK + ";" +
                                                "-fx-font-family: 'Segoe UI';" +
                                                "-fx-font-size: 24px;" +
                ...
                HBox hospitalBox = new HBox();

                hospitalBox.setAlignment(Pos.CENTER);
                setFixedHeight(hospitalBox, 50);

                hospitalBox.setPadding(
                                new Insets(
                                                0,
                                                19,
                                                0,
                ...
                hospitalBox.getChildren().add(hospitalData);
        ...
        private void showSignUpForm(VBox card) {
                ...
                TextField name = createTextField("Hospital Name");
                ...
                TextField email = createTextField("Hospital Email");
