...
//             Toast.show(DashboardPage.appOverlay, "Settings saved", "success");
//         });
...
//         FadeTransition fade = new FadeTransition(AppSettings.dur(450), settingsRoot);
...
//             TranslateTransition slideKnob = new TranslateTransition(AppSettings.dur(160), knob);
